...
=== "正确——鞭状打腿"
    ![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/bianzhaung.gif)
    使用抖腿练习
    ![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/doutui.gif)
    甩出去的是脚掌，收回来的是大腿
=== "错误——棒状打腿"
    ![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/%E6%A3%92%E7%8A%B6%E6%89%93%E8%85%BF.gif)
=== "潜水打腿"
    就是字面意思，闭气潜水，双臂并拢前伸，在水下打自由泳腿。
    ![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/qianshui.gif)
=== "侧体打腿"
    侧身位侧打自腿，支撑力不够的，前伸手臂可以使用浮板。
    - 脑袋、屁股、腿是一条直线<br>
    ![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/4.gif)
    - 屁股要绷直<br>
    - 不要用手带动转体,手前后伸直就好了
    ![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/Honeycam%202024-08-13%2002-20-11.gif)
=== "垂直打腿"
    水中直立原地垂直打腿，浮力不够的可以扶池边或者抱浮板。
    ![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/5.gif)
=== "浮板水下腿"
    浮板打腿，但是双腿不能打出水面，双腿和双脚都保持在水平面下打腿。
    ![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/6.gif)
...
- 鞭状打腿:注意大腿迅速收缩;注意小腿收回的时候，大腿要带动小腿
  ![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/21.gif)
- 注意力放脚背，练习脚背打水
![](https://philfan-pic.oss-cn-beijing.aliyuncs.com/img/20240813015121.png)
- 力量训练先大后小
