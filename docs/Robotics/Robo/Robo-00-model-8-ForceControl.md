...
!!! note "案例2:拧螺丝"
    ...
    | 约束类型 | 运动学约束 | 静力学约束 |
    |---------|------------|------------|
    | 自然约束 | $v_x = 0$ <br> $v_y = 0$ <br> $\omega_x = 0$ <br> $\omega_y = 0$ | $f_z > 0$(环境给摩擦力) <br> $\tau_z = 0$或者$\tau_z \neq 0$ |
    | 人工约束 | $v_z > 0$ <br> $\omega_z = a_1$ | $f_x = 0$ <br> $f_y = 0$ <br> $\tau_x = 0$ <br> $\tau_y = 0$ |
...
!!! note "案例5: 圆柱"
    一个圆柱靠在墙上，侧面始终和地面以及墙面接触。求自然约束和人工约束。
