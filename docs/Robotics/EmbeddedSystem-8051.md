...
上课不要听，花两到三次课或者一整个空闲时间把[这一套课程](https://www.bilibili.com/video/BV1WK411W7HP)听完。讲的简洁易懂特别好。再结合课件做补充
...
注意：内部总线先写1，使得场效应管先处于截止的状态，不然可能中间有回路导通，一直读取的是0

对总线进行取反等操作的时候，读的是内部的锁存器
