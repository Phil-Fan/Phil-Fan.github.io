...
$$
P\left[N(t)=k\right]\sim\pi(\lambda t)
=\frac {[\lambda t]^k·e^{-\lambda t}}{k!},\quad k=0,1,2,\dots
$$
...
!!! example "以 $N(t)$ 表示 $(0, t]$ 内到达某商场的顾客数，设 $\{N(t); t \geq 0\}$ 是强度为 $\lambda = 5$ 的泊松过程，进商场的各顾客独立地以概率 0.4 购物，以概率 0.6 不购物。计算 (1) 在 $(0,1]$ 内至少有 1 个顾客到达，且在 $(0,3]$ 内恰有两个顾客到达的概率； (2) 若已知在 $(0,3]$ 内恰有 1 个顾客到达，求他到达的时间在 $(1,2)$ 之间的概率； (3) 若已知在 $(0,1]$ 内至多有 2 个顾客到达，求至少有 1 个顾客购物的概率"
